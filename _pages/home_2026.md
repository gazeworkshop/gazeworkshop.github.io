  ...
  <div class="col-xs-12">
    ...
    <center>
      <table class="event-details">
        <tr><td class="item">Date:     </td><td class="desc">Tuesday, 4th June 2026      </td></tr>
  ...
  <div class="col-xs-12"><a class="anchor" id="schedule"></a>
     ...
     <table class="table schedule" style="border:none !important;">
      <thead class="thead-light">
        <tr>
	  <th>Time in UTC</th>
	  <th>Start Time in Denver<span class="tz-offset"></span><b>*</b><br><span class="tz-subtext">(probably your time zone)</span></th>
          <th>Item</th>
        </tr>
      </thead>
      <tbody>
