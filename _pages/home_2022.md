...
<div class="row">
	...
	<i>Jiawei Qin, Takuru Shimoyama, Yusuke Sugano</i>
        <div class="btn-group btn-group-xs" role="group">
          ...
          <button class="btn btn-poster-id">Poster #1</button>
	        <a class="btn btn-default" target="_blank" href=""><i class="fas fa-file-pdf"></i> PDF (CVF)</a>
        </div>
      </p>
    </div>
  ...
  <div class="award">
      <h3>
	    <b> Best Paper Honourable Mention Award </b>
	    <span class="award-sponsor">sponsored by
	...
	<i>Ryan Anthony J de Belen, Tomasz Bednarz, Arcot Sowmya</i>
        <div class="btn-group btn-group-xs" role="group">
          <button class="btn btn-success">GAZE 2022</button>
...
<div class="row">
  ...
  <div class="paper">
        ...
        <div class="btn-group btn-group-xs" role="group">
          ...
          <button class="btn btn-poster-id">Poster #1</button>
	  <a class="btn btn-default" target="_blank" href=""><i class="fas fa-file-pdf"></i> PDF (CVF)</a>
	  <a class="btn btn-default" target="_blank" href=""><i class="fas fa-archive"></i> IDIAP</a>
