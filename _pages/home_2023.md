...
<div class="row">
  <div class="col-xs-12">
    <p><center>
    <img class="img-fluid" width="900" src="{{ "img/banner.png" | prepend:site.baseurl }}">
...
<div class="row">
  ...
  <div class="row speaker">
	...
	<iframe width="560" height="315" src="https://www.youtube.com/embed/csv3v52YT1o" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        <div class="panel panel-default">
  ...
  <div class="row speaker">
	...
	<iframe width="560" height="315" src="https://www.youtube.com/embed/GvO_lRhRtPI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
	<div class="panel panel-default">
...
<div class="row">
  ...
  <div class="award">
      ...
      <p><br>
	Where are they looking in the 3D space?<br>
	<i>Nora Horanyi (University of Birmingham); Linfang Zheng (University of Birmingham); Eunji Chong (Amazon); Ales Leonardis (University of Birmingham ); Hyung Jin Chang (University of Birmingham)</i>
  ...
  <div class="award">
      ...
      <p><br>
	Kappa Angle Regression with Ocular Counter-Rolling Awareness for Gaze Estimation<br>
	<i>Shiwei Jin (UCSD); Ji Dai (UCSD); Truong Nguyen (UC San Diego)</i>
        <div class="btn-group btn-group-xs" role="group">
          <button class="btn btn-success">GAZE 2023</button>
      ...
      <p><br>
	EFE: End-to-end Frame-to-Gaze Estimation<br>
	<i>Haldun Balim (ETH Zurich); Seonwook Park (Lunit Inc.); Xi Wang (ETH Zurich); Xucong Zhang (Delft University of Technology); Otmar Hilliges (ETH Zurich)</i>
        <div class="btn-group btn-group-xs" role="group">
          <button class="btn btn-success">GAZE 2023</button>
...
<div class="row">
  ...
  <div class="paper">
        ...
        <div class="btn-group btn-group-xs" role="group">
          <button class="btn btn-success">GAZE 2023</button>
	  <button class="btn btn-poster-id">West Exhibition Hall A - Poster #212</button>
  ...
  <div class="paper">
        ...
        <div class="btn-group btn-group-xs" role="group">
          <button class="btn btn-success">GAZE 2023</button>
	  <button class="btn btn-poster-id">West Exhibition Hall A - Poster #213</button>
	  <a class="btn btn-default" target="_blank" href="https://openaccess.thecvf.com/content/CVPR2023W/GAZE/papers/Jin_Kappa_Angle_Regression_With_Ocular_Counter-Rolling_Awareness_for_Gaze_Estimation_CVPRW_2023_paper.pdf"><i class="fas fa-file-pdf"></i> PDF (CVF)</a>
  ...
  <div class="paper">
        ...
        <div class="btn-group btn-group-xs" role="group">
          <button class="btn btn-success">GAZE 2023</button>
	  <button class="btn btn-poster-id">West Exhibition Hall A - Poster #214</button>
  ...
  <div class="paper">
        ...
        <div class="btn-group btn-group-xs" role="group">
          <button class="btn btn-success">GAZE 2023</button>
	  <button class="btn btn-poster-id">West Exhibition Hall A - Poster #215</button>
	  <a class="btn btn-default" target="_blank" href="https://openaccess.thecvf.com/content/CVPR2023W/GAZE/papers/Horanyi_Where_Are_They_Looking_in_the_3D_Space_CVPRW_2023_paper.pdf"><i class="fas fa-file-pdf"></i> PDF (CVF)</a>
  ...
  <div class="paper">
        ...
        <div class="btn-group btn-group-xs" role="group">
          <button class="btn btn-success">GAZE 2023</button>
	  <button class="btn btn-poster-id">West Exhibition Hall A - Poster #216</button>
	  <a class="btn btn-default" target="_blank" href="https://openaccess.thecvf.com/content/CVPR2023W/GAZE/papers/Balim_EFE_End-to-End_Frame-To-Gaze_Estimation_CVPRW_2023_paper.pdf"><i class="fas fa-file-pdf"></i> PDF (CVF)</a>
	  <!--<a class="btn btn-default" target="_blank" href=""><i class="fas fa-file-pdf"></i> Suppl. (CVF)</a>-->
  ...
  <div class="paper">
        <span class="title">Real-Time Multi-Person Eyeblink Detection in the Wild for Untrimmed Video</span>
        <span class="authors">Wenzheng Zeng, Yang Xiao, Sicheng Wei, Jinfang Gan, Xintao Zhang, Zhiguo Cao, Zhiwen Fang, Joey Tianyi Zhou</span>
        <div class="btn-group btn-group-xs" role="group">
          <button class="btn btn-primary">CVPR 2023</button>
	  <button class="btn btn-poster-id">West Exhibition Hall A - Poster #217</button>
	  <a class="btn btn-default" target="_blank" href="https://openaccess.thecvf.com/content/CVPR2023/papers/Zeng_Real-Time_Multi-Person_Eyeblink_Detection_in_the_Wild_for_Untrimmed_Video_CVPR_2023_paper.pdf"><i class="fas fa-file-pdf"></i> PDF</a>
  ...
  <div class="paper">
        <span class="title">Source-Free Adaptive Gaze Estimation by Uncertainty Reduction</span>
        <span class="authors">Xin Cai, Jiabei Zeng, Shiguang Shan, Xilin Chen</span>
        <div class="btn-group btn-group-xs" role="group">
          <button class="btn btn-primary">CVPR 2023</button>
	  <button class="btn btn-poster-id">West Exhibition Hall A - Poster #218</button>
	  <a class="btn btn-default" target="_blank" href="https://openaccess.thecvf.com/content/CVPR2023/papers/Cai_Source-Free_Adaptive_Gaze_Estimation_by_Uncertainty_Reduction_CVPR_2023_paper.pdf"><i class="fas fa-file-pdf"></i> PDF</a>
	  <a class="btn btn-default" target="_blank" href="https://openaccess.thecvf.com/content/CVPR2023/supplemental/Cai_Source-Free_Adaptive_Gaze_CVPR_2023_supplemental.pdf"><i class="fas fa-file-pdf"></i> Supp.</a>
          <!-- <a class="btn btn-default" target="_blank" href="https://github.com/kyotovision-public/dynamic-3d-gaze-from-afar"><i class="fas fa-code"></i> Code</a> -->
	  <!-- <a class="btn btn-default" target="_blank" href="https://youtu.be/IEc8E4e4mXU"><i class="fas fa-video"></i> Video</a> -->
        </div>
    </div>
  ...
  <div class="paper">
        <span class="title">ReDirTrans: Latent-to-Latent Translation for Gaze and Head Redirection</span>
        <span class="authors">Shiwei Jin, Zhen Wang, Lei Wang, Ning Bi, Truong Nguyen</span>
        <div class="btn-group btn-group-xs" role="group">
          <button class="btn btn-primary">CVPR 2023</button>
	  <button class="btn btn-poster-id">West Exhibition Hall A - Poster #219</button>
	  <a class="btn btn-default" target="_blank" href="https://openaccess.thecvf.com/content/CVPR2023/papers/Jin_ReDirTrans_Latent-to-Latent_Translation_for_Gaze_and_Head_Redirection_CVPR_2023_paper.pdf"><i class="fas fa-file-pdf"></i> PDF</a>
	  <a class="btn btn-default" target="_blank" href="https://openaccess.thecvf.com/content/CVPR2023/supplemental/Jin_ReDirTrans_Latent-to-Latent_Translation_CVPR_2023_supplemental.pdf"><i class="fas fa-file-pdf"></i> Supp.</a>
          <!-- <a class="btn btn-default" target="_blank" href="https://github.com/kyotovision-public/dynamic-3d-gaze-from-afar"><i class="fas fa-code"></i> Code</a> -->
	  <!-- <a class="btn btn-default" target="_blank" href="https://youtu.be/IEc8E4e4mXU"><i class="fas fa-video"></i> Video</a> -->
        </div>
    </div>
  ...
  <div class="paper">
        <span class="title">GazeNeRF: 3D-Aware Gaze Redirection With Neural Radiance Fields</span>
        <span class="authors">Alessandro Ruzzi, Xiangwei Shi, Xi Wang, Gengyan Li, Shalini De Mello, Hyung Jin Chang, Xucong Zhang, Otmar Hilliges</span>
        <div class="btn-group btn-group-xs" role="group">
          <button class="btn btn-primary">CVPR 2023</button>
	  <button class="btn btn-poster-id">West Exhibition Hall A - Poster #220</button>
	  <a class="btn btn-default" target="_blank" href="https://openaccess.thecvf.com/content/CVPR2023/papers/Ruzzi_GazeNeRF_3D-Aware_Gaze_Redirection_With_Neural_Radiance_Fields_CVPR_2023_paper.pdf"><i class="fas fa-file-pdf"></i> PDF</a>
	  <a class="btn btn-default" target="_blank" href="https://openaccess.thecvf.com/content/CVPR2023/supplemental/Ruzzi_GazeNeRF_3D-Aware_Gaze_CVPR_2023_supplemental.pdf"><i class="fas fa-file-pdf"></i> Supp.</a>
          <!-- <a class="btn btn-default" target="_blank" href="https://github.com/kyotovision-public/dynamic-3d-gaze-from-afar"><i class="fas fa-code"></i> Code</a> -->
	  <!-- <a class="btn btn-default" target="_blank" href="https://youtu.be/IEc8E4e4mXU"><i class="fas fa-video"></i> Video</a> -->
        </div>
    </div>
  ...
  <div class="paper">
        <span class="title">GFIE: A Dataset and Baseline for Gaze-Following From 2D to 3D in Indoor Environments</span>
        <span class="authors">Zhengxi Hu, Yuxue Yang, Xiaolin Zhai, Dingye Yang, Bohan Zhou, Jingtai Liu</span>
        <div class="btn-group btn-group-xs" role="group">
          <button class="btn btn-primary">CVPR 2023</button>
	  <button class="btn btn-poster-id">West Exhibition Hall A - Poster #221</button>
	  <a class="btn btn-default" target="_blank" href="https://openaccess.thecvf.com/content/CVPR2023/papers/Hu_GFIE_A_Dataset_and_Baseline_for_Gaze-Following_From_2D_to_CVPR_2023_paper.pdf"><i class="fas fa-file-pdf"></i> PDF</a>
	  <a class="btn btn-default" target="_blank" href="https://openaccess.thecvf.com/content/CVPR2023/supplemental/Hu_GFIE_A_Dataset_CVPR_2023_supplemental.pdf"><i class="fas fa-file-pdf"></i> Supp.</a>
          <!-- <a class="btn btn-default" target="_blank" href="https://github.com/kyotovision-public/dynamic-3d-gaze-from-afar"><i class="fas fa-code"></i> Code</a> -->
	  <!-- <a class="btn btn-default" target="_blank" href="https://youtu.be/IEc8E4e4mXU"><i class="fas fa-video"></i> Video</a> -->
        </div>
    </div>
