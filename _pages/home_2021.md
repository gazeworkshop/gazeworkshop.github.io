...
Specifically, the workshop topics include (but are not limited to):
    ...
    <ul>
      <li>Reformulating eye detection and gaze estimation pipelines with deep networks.</li>
      <li>Applying geometric constraints into the training of (sparse or dense) deep networks.</li>
